...
export const metadata: Metadata = {
  ...
  description:
    "Jaden Oca (@jadeneoca) is a stats, psychology, mindset & AI content creator with 6k+ followers across 4 platforms. Worked with brands including Monarch Money, Blossom Social, Higgsfield AI, Polymarket, and Finvest.",
