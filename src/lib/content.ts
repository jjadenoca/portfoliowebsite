...
export const activities: Activity[] = [
  {
    ...
    bullets: [
      "Lead team of 45 to plan & execute 12 annual social events for 500 members across 6 \"families\" to promote Chinese culture on campus",
      "Manage $35K budget, planning 9 fundraisers, reducing expenses by 8%, and presenting cost-breakdown analyses after each event",
      "Direct organizational strategy via bi-weekly executive and officer meetings, boosting productivity and shortening meetings by 34%",
      "Conduct monthly trainings to aid team in goal setting, conflict resolution, & communication, increasing feedback rating by 23%",
